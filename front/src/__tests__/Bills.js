...
// describe permet de regrouper des tests par contexte, et test définit les tests individuels.

describe("Given I am connected as an employee", () => {
  // Lorsque je suis sur la page des notes de frais
  describe("When I am on Bills Page", () => {
    // Test : vérification que l'icone est highlighted/surbrillance.
    test("Then bill icon in vertical layout should be highlighted", async () => {
      ...
      // ajout de expect pour ce test = Vérification que l'icône de la fenêtre est mise en surbrillance (classe 'active-icon')
...
/***************************************************************************************************/
    ...
    test("Then bills should be ordered from earliest to latest", () => {
      ...
      const antiChrono = (a, b) => ((a < b) ? 1 : -1) // date de la plus récente à la plus ancienne
